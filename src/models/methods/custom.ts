...
export default (
  ...
  eventEmitter: EventEmitterInterface
    ...
    const limit = maxFiles === '' || maxFiles === undefined ? undefined : parseInt(maxFiles, 10)

    const total = limit === undefined ? prevResults.length : Math.min(limit, prevResults.length)
